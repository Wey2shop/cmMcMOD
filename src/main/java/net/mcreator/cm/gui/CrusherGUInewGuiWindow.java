...
@OnlyIn(Dist.CLIENT)
public class CrusherGUInewGuiWindow extends ContainerScreen<CrusherGUInewGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public CrusherGUInewGuiWindow(CrusherGUInewGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
