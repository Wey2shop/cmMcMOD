...
public class Slot1ChangeCrusherProcedure extends CmModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((new Object() {
		...
		}.getItemStack((int) (2))).getItem() == new ItemStack(Items.DIAMOND_SWORD, (int) (1)).getItem()) && ((new Object() {
			public ItemStack getItemStack(int sltid) {
				Entity _ent = entity;
				if (_ent instanceof ServerPlayerEntity) {
					Container _current = ((ServerPlayerEntity) _ent).openContainer;
			...
			if (entity instanceof PlayerEntity) {
				...
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						ItemStack _setstack = new ItemStack(DiamondFireSwordItem.block, (int) (1));
