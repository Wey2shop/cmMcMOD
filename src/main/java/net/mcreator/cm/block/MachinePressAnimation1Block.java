...
public class MachinePressAnimation1Block extends CmModElements.ModElement {
	@ObjectHolder("cm:machine_press_animation_1")
	public static final Block block = null;
	public MachinePressAnimation1Block(CmModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("machine_press_animation_1");
		}
