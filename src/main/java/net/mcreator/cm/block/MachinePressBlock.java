...
import net.mcreator.cm.procedures.MachineBlockAnimationSCRIPTProcedure;
...
public class MachinePressBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:machine_press")
	public static final Block block = null;
	public MachinePressBlock(CmModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				MachineBlockAnimationSCRIPTProcedure.executeProcedure($_dependencies);
			}
