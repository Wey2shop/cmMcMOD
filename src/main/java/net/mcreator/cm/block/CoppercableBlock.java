...
public class CoppercableBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:coppercable")
	public static final Block block = null;
	@ObjectHolder("cm:coppercable")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CoppercableBlock(CmModElements instance) {
		super(instance, 98);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("coppercable"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
