...
import net.mcreator.cm.procedures.SolarPanel1Procedure;
...
public class SolarPanelONEBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:solar_panel_one")
	public static final Block block = null;
	@ObjectHolder("cm:solar_panel_one")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanelONEBlock(CmModElements instance) {
		super(instance, 91);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("solar_panel_one"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("solar_panel_one");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SolarPanel1Procedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("solar_panel_one");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(0, 10, 10, 0) {
			@Override
