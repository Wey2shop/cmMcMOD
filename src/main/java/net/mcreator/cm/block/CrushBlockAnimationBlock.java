...
public class CrushBlockAnimationBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:crush_block_animation")
	public static final Block block = null;
	public CrushBlockAnimationBlock(CmModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crush_block_animation");
		}
