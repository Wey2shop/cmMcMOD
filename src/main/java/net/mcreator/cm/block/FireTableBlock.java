...
import net.mcreator.cm.procedures.FireTableParticleSpawningConditionProcedure;
...
public class FireTableBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:fire_table")
	public static final Block block = null;
	@ObjectHolder("cm:fire_table")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FireTableBlock(CmModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fire_table"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Fire Table");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new FireBTableGUIGui.GuiContainerMod(id, inventory,
			...
			Direction direction = hit.getFace();
			{
				...
				FireTableParticleSpawningConditionProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("fire_table");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new FireBTableGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
