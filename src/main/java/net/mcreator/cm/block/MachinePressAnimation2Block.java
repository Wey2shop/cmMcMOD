...
public class MachinePressAnimation2Block extends CmModElements.ModElement {
	@ObjectHolder("cm:machine_press_animation_2")
	public static final Block block = null;
	public MachinePressAnimation2Block(CmModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("machine_press_animation_2");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MachinePressBlock.block, (int) (1)));
		}
	}
}
