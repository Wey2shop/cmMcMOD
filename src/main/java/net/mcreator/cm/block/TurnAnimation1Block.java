...
import net.mcreator.cm.procedures.TurnAnimationProcedureProcedure;
...
public class TurnAnimation1Block extends CmModElements.ModElement {
	@ObjectHolder("cm:turn_animation_1")
	public static final Block block = null;
	public TurnAnimation1Block(CmModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("turn_animation_1");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				TurnAnimationProcedureProcedure.executeProcedure($_dependencies);
			}
