...
import net.mcreator.cm.procedures.BatteryStorageProcedureProcedure;
...
public class BatteryblockBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:batteryblock")
	public static final Block block = null;
	@ObjectHolder("cm:batteryblock")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryblockBlock(CmModElements instance) {
		super(instance, 94);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BatteryStorageProcedureProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(15, 15, 15, 0) {
			@Override
