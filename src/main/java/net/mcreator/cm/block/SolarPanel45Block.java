...
public class SolarPanel45Block extends CmModElements.ModElement {
	@ObjectHolder("cm:solar_panel_45")
	public static final Block block = null;
	@ObjectHolder("cm:solar_panel_45")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanel45Block(CmModElements instance) {
		super(instance, 96);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("solar_panel_45"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("solar_panel_45");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("solar_panel_45");
		}
