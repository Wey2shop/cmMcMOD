...
public class MachinePressLIDBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:machine_press_lid")
	public static final Block block = null;
	public MachinePressLIDBlock(CmModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("machine_press_lid");
		}
