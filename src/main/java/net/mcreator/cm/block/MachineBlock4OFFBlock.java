...
public class MachineBlock4OFFBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:machine_block_4_off")
	public static final Block block = null;
	public MachineBlock4OFFBlock(CmModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 1).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("machine_block_4_off");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MachineBlock4OFFBlock.block, (int) (1)));
		}
