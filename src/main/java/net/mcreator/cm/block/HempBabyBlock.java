...
public class HempBabyBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:hemp_baby")
	public static final Block block = null;
	public HempBabyBlock(CmModElements instance) {
		super(instance, 118);
	}
