...
public class Crusher2OPENBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:crusher_2_open")
	public static final Block block = null;
	@ObjectHolder("cm:crusher_2_open")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Crusher2OPENBlock(CmModElements instance) {
		super(instance, 59);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("crusher_2_open"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crusher_2_open");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrusherBlock.block, (int) (1)));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("crusher_2_open");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Crusher 2 OPEN");
		}
