...
public class Aluminium_OreBlockBlock extends CmModElements.ModElement {
	@ObjectHolder("cm:aluminium_ore_block")
	public static final Block block = null;
	public Aluminium_OreBlockBlock(CmModElements instance) {
		super(instance, 19);
	}
