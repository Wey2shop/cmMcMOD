...
import net.mcreator.cm.procedures.Hemp3DropProcedure;
...
public class Hemp3Block extends CmModElements.ModElement {
	@ObjectHolder("cm:hemp_3")
	public static final Block block = null;
	public Hemp3Block(CmModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HempSeedsItem.block, (int) (1)));
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				Hemp3DropProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
