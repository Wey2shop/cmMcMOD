...
import net.mcreator.cm.procedures.CopperCableScriptProcedure;
import net.mcreator.cm.procedures.CableWrenchActivateClipScriptProcedure;
...
public class CopperCable90Block extends CmModElements.ModElement {
	@ObjectHolder("cm:copper_cable_90")
	public static final Block block = null;
	@ObjectHolder("cm:copper_cable_90")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CopperCable90Block(CmModElements instance) {
		super(instance, 99);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("copper_cable_90"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends FallingBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("copper_cable_90");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				CopperCableScriptProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CableWrenchActivateClipScriptProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("copper_cable_90");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Coppercable");
		}
