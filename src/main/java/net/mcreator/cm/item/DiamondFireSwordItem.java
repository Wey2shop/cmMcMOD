...
public class DiamondFireSwordItem extends CmModElements.ModElement {
	@ObjectHolder("cm:diamond_fire_sword")
	public static final Item block = null;
	public DiamondFireSwordItem(CmModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Item modifier", (double) 98, AttributeModifier.Operation.ADDITION));
		...
		public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
			...
			World world = entity.world;
			{
				...
				DiamondFireSwordLivingEntityIsHitWithItemProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
