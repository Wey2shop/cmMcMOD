...
public class CopperPressedplateItem extends CmModElements.ModElement {
	@ObjectHolder("cm:copper_pressedplate")
	public static final Item block = null;
	public CopperPressedplateItem(CmModElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copper_pressedplate");
		}
