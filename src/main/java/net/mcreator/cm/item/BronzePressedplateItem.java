...
public class BronzePressedplateItem extends CmModElements.ModElement {
	@ObjectHolder("cm:bronze_pressedplate")
	public static final Item block = null;
	public BronzePressedplateItem(CmModElements instance) {
		super(instance, 81);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bronze_pressedplate");
		}
