...
public class AluminiumDiskItem extends CmModElements.ModElement {
	@ObjectHolder("cm:aluminium_disk")
	public static final Item block = null;
	public AluminiumDiskItem(CmModElements instance) {
		super(instance, 89);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aluminium_disk");
		}
