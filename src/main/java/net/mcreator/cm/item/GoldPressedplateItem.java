...
public class GoldPressedplateItem extends CmModElements.ModElement {
	@ObjectHolder("cm:gold_pressedplate")
	public static final Item block = null;
	public GoldPressedplateItem(CmModElements instance) {
		super(instance, 75);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("gold_pressedplate");
		}
