...
public class IronPressedplateItem extends CmModElements.ModElement {
	@ObjectHolder("cm:iron_pressedplate")
	public static final Item block = null;
	public IronPressedplateItem(CmModElements instance) {
		super(instance, 76);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_pressedplate");
		}
