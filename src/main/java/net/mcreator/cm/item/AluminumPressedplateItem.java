...
public class AluminumPressedplateItem extends CmModElements.ModElement {
	@ObjectHolder("cm:aluminum_pressedplate")
	public static final Item block = null;
	public AluminumPressedplateItem(CmModElements instance) {
		super(instance, 78);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aluminum_pressedplate");
		}
